...
| --- | --- | --- |
| claude-fable-5.1 • max | Devin | [<img src="./claude-fable-5.1/claude-fable-5.1_max_devin-cli.svg" alt="claude-fable-5.1 • max — Devin" width="256">](./claude-fable-5.1/claude-fable-5.1_max_devin-cli.svg) |
